...
?>
    ...
    <div id="main">
        ...
        <?php if(isset($error)){ ?>
            ...
            <form action="<?php echo site_url('ControleurLogAdmin/traitementinscription'); ?>" method="post">
            ...
            <p><button><a href="<?php echo site_url('ControleurLogAdmin/index'); ?>">connexion</a></button></p>
    </div>
    </center>
<?php
